...
const w = obj({ firstName: 'abdulrhman', lastName: "altyeb" })


const obj2 = <T extends {firstName:string,lastName:string}>(obj:T) => {
    return {
        ...obj,
        fullName: obj.firstName + ' ' + obj.lastName
    }
...
const w2 = obj2({ firstName: 'abdulrhman', lastName: "altyeb", age: 15 })
...
type numberProp = Props<number>
type stirngProp = Props<stringJ>